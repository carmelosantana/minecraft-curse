...
This plugin's row: the updater reported `TheCurse: installed v0.2.2` from the published release
...
Co-resident: AguaDeFlorida 2.0.0, CopperKingdom 0.2.1, DeathDepot 1.1.1, ElectricFurnace 0.2.1, GlutenFreeBread 1.1.3, Ollama 0.2.1, StarterPack 1.1.2, TimberBlast 1.0.0, Umami 1.1.1, WildWeatherUpdate 1.0.2, WorldCRUD 1.1.2.
