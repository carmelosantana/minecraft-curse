# Makefile for The Curse Plugin Server Management
...
help: ## Show this help message
	@echo "🧙 The Curse Plugin - Development Commands"
	@echo ""
...
test-commands: build install ## Build, install and show test commands
	...
	@echo "  /curse start            - Force start a curse (admin)"
	@echo "  /curse stop             - Force stop current curse (admin)"
	@echo "  /curse leaderboard      - View curse statistics"
	@echo "  /curse help             - Show command help"
	@echo ""
	@echo "=== Admin Commands (op required) ==="
	@echo "  /curse reload           - Reload plugin configuration"
	@echo ""
	@echo "=== Natural Trigger ==="
	@echo "  Drink Bad Omen potion at night to start curse naturally"
	@echo ""
...
release: validate build ## Create a release build
	...
	@mkdir -p releases
	@cp target/curse-*.jar releases/
	@echo "✅ Release created in releases/ directory"

# Create bad omen potion for testing
give-bad-omen: ## Give bad omen potion to test curse trigger
	@echo "Creating bad omen potion command..."
	@echo "Run this in game: /give @p minecraft:potion{Potion:\"minecraft:bad_omen\"} 1"
	@echo "Or use: /effect give @p minecraft:bad_omen 600 0"
